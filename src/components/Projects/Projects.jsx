      ...
      <section id="project-section" className={styles.section}>
        <div className={styles.headerSection}>
          <div className={styles.container}>
            <h3 className={styles.mainHeading}>Projects</h3>
            ...
            <div className={styles.basicProjects}>
              <div className={styles.basicProject}>
                ...
                <p className={styles.basicDescription}>
                  A hangman game where you have to guess the word generated by
                  computer by guessing the letters.
                </p>
              ...
              <div className={styles.basicProject}>
                ...
                <p className={styles.basicDescription}>
                  Listen to your favorite music on the go. And enjoy our
                  playlist of some of the top songs.
                </p>
                <div className={styles.basicButtons}>
                  <a
              ...
              <div className={styles.basicProject}>
                ...
                <p className={styles.basicDescription}>
                  Dive into the world of trivia with my Simple Quiz App, created
                  with vanilla JavaScript!
                </p>
                <div className={styles.basicButtons}>
                  <a
                    target="_blank"
                    href="https://quizapp-by-uzair-khan.onrender.com/"
                  >
                    <button className={styles.basicWebsite}>
                      See in Action
                    </button>
            ...
            <div className={styles.project}>
              ...
              <div className={styles.right}>
                ...
                <p className={styles.description}>
                  A blog platform where users can create, edit, and delete blog
                  posts with ease .
                </p>
